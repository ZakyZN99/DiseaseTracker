...
class FeedbackScreenAdmin extends StatefulWidget {
  @override
  _FeedbackScreenAdminState createState() => _FeedbackScreenAdminState();
}

class _FeedbackScreenAdminState extends State<FeedbackScreenAdmin> {
  bool circular = true;
  String? data = "";
      ...
      body: circular
          ...
          : ListView(
              children: [
                new Padding(
                  padding:
                      EdgeInsets.only(top: 50, left: 20, right: 30, bottom: 10),
                  child: CircleAvatar(
